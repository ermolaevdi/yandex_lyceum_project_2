...
class Buttons:
    ...
    def __init__(self):
        ...
        self.buttons.append(Button(Buttons.CHECK, 780, 150, ["4.png", "3.png"],
                                   "Проверить правильность решения?"
                                   "Помни, что счётчик ошибок может увеличиться :)", font))
        self.buttons.append(Button(Buttons.RESTART, 780, 230, ["24.png", "23.png"],
                                   "Начать прохождение уровня заново", font))
        self.buttons.append(Button(Buttons.ADVICE, 780, 290, ["8.png", "7.png"],
                                   "Открыть любые 1-3 клетки", font))

        self.buttons.append(Button(Buttons.NEXT, 780, 440, ["16.png", "15.png"],
                                   "Следующий уровень", font))
        self.buttons.append(Button(Buttons.PREV, 780, 470, ["18.png", "17.png"],
                                   "Предыдущий уровень", font))
        self.buttons.append(Button(Buttons.RULES, 780, 530, ["20.png", "19.png"],
                                   "Правила игры", font))
        self.buttons.append(Button(Buttons.EXIT, 780, 570, ["6.png", "5.png"],
                                   "Выйти из головоломки", font))
        self.buttons.append(Button(Buttons.RESET, 780, 600, ["22.png", "21.png"],
        ...
        self.buttons.append(Button(Buttons.AUTHOR, 780, 640, ["2.png", "1.png"],
    ...
    def draw(self, scene, mouse_x, mouse_y, pressable):
        ...
        for btn in self.buttons:
            if btn.id_button == Buttons.ADVICE and advice > 0 and error < 8:
                ...
                res = btn.draw(scene, mouse_x, mouse_y, pressable)
            elif btn.id_button != Buttons.ADVICE and btn.id_button != Buttons.NEXT and \
        ...
        if error < 8:
            res = self.buttons_difficulty[difficulty].draw(scene, mouse_x, mouse_y, pressable)
...
class Button:
    ...
    def __init__(self, id_btn, x, y, im_name_file, advice_r, font):

        self.id_button = id_btn
        self.x = x
        self.y = y
        self.images = []
        self.advice = advice_r
        self.font = font
    ...
    def write_advice(self, scene):
        sc = self.font.getSystemText(f"N{self.y}", f"{self.advice}", COLOR_YELLOW_DARK)
